...
ActiveRecord::Schema.define(version: 2024_07_25_060051) do
  ...
  create_table "post_comments", force: :cascade do |t|
    ...
    t.index ["producer_id"], name: "index_post_comments_on_producer_id"
  end
  ...
  add_foreign_key "post_comments", "producers"
end
